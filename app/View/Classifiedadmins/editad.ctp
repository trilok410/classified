    ...
    <div id="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
            	<div class="post_main">
               <div class="post_left">
                  <form class="form-horizontal" id="post_adform" method="post" action="<?php echo $this->webroot ?>classifiedadmins/updatepostadd" enctype="multipart/form-data">
                      ...
                      <section class="form_section">
	                        <div class="form_sec_inner">
	                            ...
	                            <div id="load_pages">
	                                ...
	                                <div class="form-group">
	                                    <label for="name" class="col-sm-3 control-label">Ad type<span>*</span></label>
	                                    <div class="col-sm-9">
	                                      <div class="radio_box">
	                                          <label class="radio-inline"><input type="radio" name="post_type" value="1" <?php echo ($add["classifieds"]["post_type"] == 1)? "checked" : ""; ?> >I want to Sell</label>
	                                          <label class="radio-inline"><input type="radio" name="post_type" value="2" <?php echo ($add["classifieds"]["post_type"] == 2)? "checked" : ""; ?>>I want to Buy</label>
	                                      </div>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-6">
	                                        ...
	                                        <label class="radio-inline">
	                                          <input type="radio" name="typeofadd" id="typeofadd1" value="1" <?php echo ($add["classifieds"]["typeofadd"] == 1)? "checked" : ""; ?>>Rent
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="radio" name="typeofadd" id="typeofadd2" value="2"<?php echo ($add["classifieds"]["typeofadd"] == 2)? "checked" : ""; ?>>Sell
	                                        </label>
	                                        </div>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                  <div class="price_main">
	                                      ...
	                                      <div class="price_list">
	                                        <ul>
	                                            <!-- <li>00 EUR</li> -->
	                                            <li><label class="radio-inline"><input type="radio" name="price_type" value="fixed"  <?php echo ($add["classifieds"]["price_type"] == "fixed")? "checked" : ""; ?>>Fixed price</label></li>
	                                            <li><label class="radio-inline"><input type="radio" name="price_type" value="negotiable" <?php echo ($add["classifieds"]["price_type"] == "negotiable")? "checked" : ""; ?>>Negotiable</label></li>
	                                            <li><label class="radio-inline"><input type="radio" name="price_type" value="to give away" <?php echo ($add["classifieds"]["price_type"] == "to give away")? "checked" : ""; ?>>To give away</label></li>
	                                            <div class="clearfix"></div>
	                                        </ul>
	                                      </div>
	                                  </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-6">
	                                      <div class="radio_sec">
	                                        <label class="radio-inline">
	                                          <input type="radio" name="condition_type" id="inlineRadio1" value="1" <?php echo ($add["classifieds"]["condition_type"] == 1)? "checked" : ""; ?>> New
	                                        </label>
	                                        <label class="radio-inline">
	                                          <input type="radio" name="condition_type" id="inlineRadio2" value="2" <?php echo ($add["classifieds"]["condition_type"] == 2)? "checked" : ""; ?>> Used
	                                        </label>
	                                      </div>
	                                    </div>
	                                </div> 
	                                ...
	                                <div class="form-group">
	                                    <label class="control-label col-sm-3" for="fuel">Model*</label>
	                                    <div class="col-sm-4">
	                                ...
	                                <div class="form-group">
	                                    <label class="control-label col-sm-3" for="fuel">Fuel*</label>
	                                    <div class="col-sm-4">
	                                    <select class="form-control" name="fuel" id="fuel" required>
	                                      <option selected disabled>Select Fuel</option>
	                                      <option value="Petrol" <?php echo ($add["classifieds"]["fuel"] == $lang["Petrol"])? "selected" : ""; ?>>Petrol</option>
	                                      <option value="Diesel" <?php echo ($add["classifieds"]["fuel"] == $lang["Diesel"])? "selected" : ""; ?>>Diesel</option>
	                                      <option value="LPG" <?php echo ($add["classifieds"]["fuel"] == $lang["LPG"])? "selected" : ""; ?>>LPG</option>
	                                      <option value="CNG" <?php echo ($add["classifieds"]["fuel"] == $lang["CNG"])? "selected" : ""; ?>>CNG</option>
	                                    </select>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-6">
	                                      <div class="radio_sec">
	                                        <label class="radio-inline">
	                                          <input type="radio" name="furnished" id="furnished1" value="Yes" <?php echo ($add["classifieds"]["furnished"] == "Yes")? "checked" : ""; ?>>Yes
	                                        </label>
	                                        <label class="radio-inline">
	                                            <input type="radio" name="furnished" id="furnished2" value="No" <?php echo ($add["classifieds"]["furnished"] == "No")? "checked" : ""; ?>>No
	                                        </label>
	                                      </div>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    <label class="control-label col-sm-3" for="rooms">Rooms*</label>
	                                    <div class="col-sm-6">
	                                    <select class="form-control" name="rooms" id="rooms" required>
	                                      <option selected disabled>Select Rooms</option>
	                                      <option value="1" <?php echo ($add["classifieds"]["rooms"] == 1)? "selected" : ""; ?>>1 Rooms</option>
	                                      <option value="2" <?php echo ($add["classifieds"]["rooms"] == 2)? "selected" : ""; ?>>2 Rooms</option>
	                                      <option value="3" <?php echo ($add["classifieds"]["rooms"] == 3)? "selected" : ""; ?>>3 and More</option>
	                                    </select>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    <label class="control-label col-sm-3" for="add_type">Type of ad*</label>
	                                    <div class="col-sm-6">
	                                    <select class="form-control" name="job_type" id="add_type" required>
	                                      <option>Choose</option>
	                                      <option value="1" <?php echo ($add["classifieds"]["job_type"] == 1)? "selected" : ""; ?>>Offering job</option>
	                                      <option value="2" <?php echo ($add["classifieds"]["job_type"] == 2)? "selected" : ""; ?>>Seeking job</option>
	                                    </select>
	                                    </div>
	                                </div>
	                                ...
	                                <div id="show_off_data">
	                                    <div class="form-group">
	                                      <label class="control-label col-sm-3" for="salary_period">Salary period*</label>
	                                        <div class="col-sm-6">
	                                        <select class="form-control" name="salary_period" id="salary_period" required>
	                                          <option value="">Choose</option>
	                                          <option value="hourly" <?php echo ($add["classifieds"]["salary_period"] == "hourly")? "selected" : ""; ?>>Hourly</option>
	                                          <option value="weekly" <?php echo ($add["classifieds"]["salary_period"] == "weekly")? "selected" : ""; ?>>Weekly</option>
	                                          <option value="monthly" <?php echo ($add["classifieds"]["salary_period"] == "monthly")? "selected" : ""; ?>>Monthly</option>
	                                          <option value="yearly" <?php echo ($add["classifieds"]["salary_period"] == "yearly")? "selected" : ""; ?>>Yearly</option>
	                                        </select>
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-sm-3">
	                                            <input type="text" class="form-control" name="salary_from" value="<?php echo $add["classifieds"]["salary_from"]; ?>" id="salary_range" placeholder="From" required>
	                                        </div>
	                                        <div class="col-sm-3">
	                                            <input type="text" class="form-control" name="salary_to" value="<?php echo $add["classifieds"]["salary_to"]; ?>" id="salary_range1" placeholder="To" required>
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                      <label class="control-label col-sm-3" for="position_type">Position type*</label>
	                                        <div class="col-sm-6">
	                                        <select class="form-control" name="position_type" id="position_type" required>
	                                          <option value="">Choose</option>
	                                          <option value="fulltime" <?php echo ($add["classifieds"]["position_type"] == "fulltime")? "selected" : ""; ?>>Full-time</option>
	                                          <option value="parttime" <?php echo ($add["classifieds"]["position_type"] == "parttime")? "selected" : ""; ?>>Part-time</option>
	                                          <option value="contract" <?php echo ($add["classifieds"]["position_type"] == "contract")? "selected" : ""; ?>>Contract</option>
	                                          <option value="temporary" <?php echo ($add["classifieds"]["position_type"] == "temporary")? "selected" : ""; ?>>Temporary</option>
	                                        </select>
	                                        </div>
	                                    </div>
	                                </div>
	                                ...
	                                <div id="show_off_data" style="display:none">
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-sm-3">
	                                            <input type="text" class="form-control" name="salary_from" id="salary_range" placeholder="From">
	                                        </div>
	                                        <div class="col-sm-3">
	                                            <input type="text" class="form-control" name="salary_to" id="salary_range1" placeholder="To">
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                      <label class="control-label col-sm-3" for="position_type">Position type*</label>
	                            ...
	                            <div class="form-group">
	                              ...
	                              <div class="col-sm-9">
	                               <textarea class="form-control show_tip" id="description" name="description" placeholder="include the brand model" required><?php echo $add["classifieds"]["description"]; ?></textarea>
	                            ...
	                            <div class="form-group current">
	                              ...
	                              <div class="col-sm-9">
	                                <input type="text" class="form-control" value="<?php echo $add["classifieds"]["name"]; ?>" name="name" id="name" placeholder="" required>
	                              	<input type="hidden" id="user_id" name="user_id" value="<?php echo $add["classifieds"]["user_id"]; ?>">
	                              </div>
	                            </div>
	                            <div class="form-group">
	                              <label for="email" class="col-sm-3 control-label">Email<span>*</span></label>
	                              <div class="col-sm-9">
	                                <input type="email" class="form-control" name="email" value="<?php echo $add["classifieds"]["email"]; ?>" id="email" placeholder="" required>
	                              </div>
	                            </div>
	                            <div class="form-group current">
                      ...
                      <button type="submit" class="btn btn-default btn_submit" id="submit_form">Update</button>
                      <button type="button" class="btn btn-danger btn_cancel" id="btn_cancel">Cancel</button>
                      <div class="clearfix"></div>
                  </form>
               </div>
             </div>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $("body").on("click", "#btn_cancel", function(){
            window.location.href = "<?php echo $this->webroot; ?>classifiedadmins/useradds";
      });
