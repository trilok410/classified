<div class="all_cat_list">
    ...
    <a href="javascript:void(0)" class="category" m_id="<?php echo $maincat[0]["classified_maincategories"]["m_id"]; ?>" main="<?php echo $category[0]["classified_category"]["c_id"]; ?>"><h4><?php echo $category[0]["classified_category"]["category"]; ?></h4></a>
</div>
<div class="ad_list">
