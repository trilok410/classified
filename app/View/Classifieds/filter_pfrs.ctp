...
<div class="left_box_list">
   <div class="left_heading">
       <h2><?php echo $lang["Furnished"]; ?></h2>
       <div class="panel_list">
          <div class="panel_filter">
            <div class="checkbox">
                <label class="radio-inline">
        					<input type="radio" name="furnished" class="furnished" value="Yes" <?php echo (isset($data["fur"]) && !empty($data["fur"]) && $data["fur"] == "Yes")? "checked" : ""; ?>><?php echo $lang["Yes"]; ?> 
        			  </label>
    	          <label class="radio-inline">
    		            <input type="radio" name="furnished" class="furnished" value="No" <?php echo (isset($data["fur"]) && !empty($data["fur"]) && $data["fur"] == "No")? "checked" : ""; ?>><?php echo $lang["No"]; ?> 
    	          </label>
            </div>
          </div>
      </div>
        ...
        <div class="panel_filter">
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="select_room" value="1" <?php echo (isset($data["room"]) && !empty($data["room"]) && in_array(1, $data["room"]))? "checked" : ""; ?>> 1 <?php echo $lang["Rooms"]; ?>
               </label>
          </div>
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="select_room" value="2" <?php echo (isset($data["room"]) && !empty($data["room"]) && in_array(2, $data["room"]))? "checked" : ""; ?>> 2 <?php echo $lang["Rooms"]; ?>
               </label>
          </div>
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="select_room" value="3" <?php echo (isset($data["room"]) && !empty($data["room"]) && in_array(3, $data["room"]))? "checked" : ""; ?>> 3 <?php echo $lang["and More"]; ?>
               </label>
          </div>
        </div>
       </div>
