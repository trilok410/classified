...
<div class="left_box_list">
   <div class="left_heading">
       <h2><?php echo $lang["Fuel"]; ?></h2>
       <div class="panel_list">
        <div class="panel_filter"> 
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="fuel_type" value="<?php echo $lang["Petrol"]; ?>" <?php echo (isset($data["fuel"]) && !empty($data["fuel"]) && in_array("Petrol", $data["fuel"]))? "checked" : ""; ?> > <?php echo $lang["Petrol"]; ?>
               </label>
          </div>
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="fuel_type" value="<?php echo $lang["Diesel"]; ?>" <?php echo (isset($data["fuel"]) && !empty($data["fuel"]) && in_array("Diesel", $data["fuel"]))? "checked" : ""; ?>> <?php echo $lang["Diesel"]; ?>
               </label>
          </div>
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="fuel_type" value="<?php echo $lang["LPG"]; ?>" <?php echo (isset($data["fuel"]) && !empty($data["fuel"]) && in_array("LPG", $data["fuel"]))? "checked" : ""; ?>> <?php echo $lang["LPG"]; ?>
               </label>
          </div>
          <div class="checkbox">
               <label class="lowercase">
                  <input type="checkbox" class="fuel_type" value="<?php echo $lang["CNG"]; ?>" <?php echo (isset($data["fuel"]) && !empty($data["fuel"]) && in_array("CNG", $data["fuel"]))? "checked" : ""; ?>> <?php echo $lang["CNG"]; ?>
               </label>
          </div>
         </div>
        </div>
