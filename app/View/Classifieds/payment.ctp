                     ...
                     <div class="row ">
                       ...
                       <div class="col-md-4 col-sm-4">
                        <div class="checkout_amnt text-right">
                            <h2><?php echo $lang["Amount"]; ?>:<?php echo $u_amt["totalamt"]; ?></h2>
                        </div>
                       </div>
                     </div>
                </div>
                 <div class="checkout_tab">
                    <h3><?php echo $lang["Select"]." ".$lang["Payment"]." ".$lang["Option"]; ?></h3>
                    
                     <!-- Nav tabs -->
                      <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation"><a href="#Paypal" aria-controls="Paypal" role="tab" data-toggle="tab"><i class="fa fa-paypal"></i><?php echo $lang["Paypal"]; ?></a></li>
                        <li role="presentation"><a href="#sofort" aria-controls="Paypal" role="tab" data-toggle="tab">Sofort</a></li>                        
                        <li role="presentation" class="active"><a href="#Card" aria-controls="Card" role="tab" data-toggle="tab"><i class="fa fa-credit-card-alt"></i><?php echo $lang["Credit / Debit Card."]; ?> </a></li>
                      </ul>
                      ...
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane paypal_form" id="Paypal">
                            <form action="<?php echo $paypal_url; ?>" method="post" name="frmPayPal1">
                                ...
                                <input type="hidden" name="cancel_return" value="<?php echo $site_url; ?>classifieds/confirm_pay">
                                <input type="hidden" name="return" value="<?php echo $site_url; ?>classifieds/confirm_pay">
                                <input type="hidden" name="bn" value="Business_BuyNow_WPS_SE" />
                                <div class="form-group">
                                    <button type="submit" class="btn btn-default payment_submit"><span class="fa fa-paypal"></span><?php echo $lang["Paypal"]; ?></button>
                                </div>
                            </form>
                        </div>
                        <div role="tabpanel" class="tab-pane paypal_form" id="sofort">
                            <form method="post" action="<?php echo $this->webroot; ?>classifieds/dosofort">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="Card">
                            <form class="credit_card" role="form" method="post" action="<?php echo $this->webroot; ?>classifieds/payment">
                              <div class="form-group">
                                <label for=""><?php echo $lang["Credit / Debit Card No."]; ?></label>
                              ...
                              <div class="form-group form-inline">
                                    <div class="row">
                                        <div class="col-md-6 col-md-6">
                                            <label for=""><?php echo $lang["Card Expiration Date"]; ?></label>
                                        ...
                                        <div class="col-md-6 col-sm-6 cvv_number">
                                            <label for=""><?php echo $lang["Card CVV No."]; ?></label>
                                            <div class="input-group">
                              ...
                              <div class="credit_btn">
                                ...
                                <button type="submit" class="btn btn-primary"><?php echo $lang["Pay Now"]; ?></button>
                              </div>
                            </form>
                        </div>
                      </div>
